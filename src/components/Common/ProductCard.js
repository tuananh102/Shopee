      ...
      <a className="home-product__item p-3" href="/#">
        <div className="home-product__box-img">
          <img
            ...
            alt="Samsung Galaxy S22 Ultra (8GB - 128GB)"
          />
        </div>
        ...
        <div className="home-product__item-price">
          <span className="home-product__item-price-new">₫6.350.000</span>
          <span className="home-product__item-price-old">₫7.990.000</span>
        </div>
        <div className="home-product__item-rating">
          ...
          <span className="home-product__item-rating-number">2 Đánh giá</span>
        </div>
